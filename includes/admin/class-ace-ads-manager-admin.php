<?php
/**
 * Admin settings page for Ace Ads Manager.
 *
...
final class Ace_Ads_Manager_Admin {
    ...
    public function register_menu(): void {
        add_submenu_page(
            'edit.php?post_type=ace_ad',
            __( 'Settings', 'ace-ads-manager' ),
            __( 'Settings', 'ace-ads-manager' ),
            self::CAP,
            self::PAGE,
    ...
    public function action_links( array $links ): array {
        ...
        array_unshift( $links, '<a href="' . esc_url( $url ) . '">' . esc_html__( 'Settings', 'ace-ads-manager' ) . '</a>' );
        return $links;
    }

    public function settings_url(): string {
        return admin_url( 'edit.php?post_type=ace_ad&page=' . self::PAGE );
    }
